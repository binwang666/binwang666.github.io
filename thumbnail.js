document.addEventListener("DOMContentLoaded", function (event) {
    ...
    let targetImage9= document.querySelector("#smart-image9");

    targetImage9.addEventListener("click", function () {
        if (targetImage9.classList.contains("small")) {
            targetImage9.classList.remove("small")
        } else {
            targetImage9.classList.add("small");
        }
    })
    let targetImage10 = document.querySelector("#smart-image10");

    targetImage10.addEventListener("click", function () {
        if (targetImage10.classList.contains("small")) {
            targetImage10.classList.remove("small")
        } else {
            targetImage10.classList.add("small");
        }
    })
})
